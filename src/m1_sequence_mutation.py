...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([8, 4, 3, 9], [77, 3, 6, 1, 5, 0], [4, 4, 4], [4, 0, 4])
    expected2 = ([8, 4, 3, 9], [77, 3, 6, 1, 5, 1], [4, 4, 4], [4, 2, 4])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 13:
    test3 = ([8, 4, 0, 9], [7, 0, 0, 1, 3, 0], [4, 3, 5], [4, 0, 0])
    expected3 = ([8, 4, 1, 9], [7, 2, 3, 1, 3, 4], [4, 3, 5], [4, 5, 6])
    zero_changer(test3)
    print()
    print('Test 3:')
